...
public class ScanBottleActivity extends AppCompatActivity implements QRCodeView.Delegate{
...
//        振动
        vibrate();
        View view = View.inflate(ScanBottleActivity.this, R.layout.view_task_detail, null);
        ...
        new AlertDialog.Builder(ScanBottleActivity.this)
                .setTitle("您确定要完成这个任务吗?")
                .setView(view)
